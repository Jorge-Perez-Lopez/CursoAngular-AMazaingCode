...
describe('AppComponent', () => {
  ...
  it('form should be invalid if required fields are empty', () => {
   ...
   it('form should be valid if required fields are empty', () => {

    const fixture = TestBed.createComponent(AppComponent);
    const app = fixture.componentInstance;

    app.movieForm.controls['name'].setValue('Star Wars');
    app.movieForm.controls['duration'].setValue('100');
  ...
  it('btn should send the form when clicked', () => {
    ...
    const sentMsg = fixture.nativeElement.querySelector('#send-msg');
